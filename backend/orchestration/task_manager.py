...
class TaskManager:
    ...
    def _create_kitchen_remodel_tasks(self, **kwargs) -> List[Task]:
        ...
        return [
            ...
            Task("3", "Carpenter", "Remove old cabinets", ["2"], "demolition", materials=["lumber", "plywood"]),
            Task("4", "Plumber", "Update plumbing rough-in", ["3"], "rough_in", materials=["pvc pipes", "copper pipes"]),
            Task("5", "Electrician", "Update electrical rough-in", ["3"], "rough_in", materials=["electrical wire", "outlets"]),
            Task(
                "6",
                "Architect",
            ...
            Task("7", "Carpenter", "Install new cabinets", ["6"], "finishing", materials=["plywood", "lumber"]),
            Task("8", "Electrician", "Install lighting fixtures", ["7"], "finishing", materials=["light fixtures", "electrical wire"]),
            Task("9", "Plumber", "Install sink and fixtures", ["7"], "finishing", materials=["sink", "pvc pipes"]),
            Task("10", "Painter", "Paint walls", ["7"], "finishing", materials=["interior paint", "primer"]),
            Task(
                "11",
                "Architect",
                "Final inspection",
    ...
    def _create_bathroom_remodel_tasks(self, **kwargs) -> List[Task]:
        ...
        return [
            ...
            Task("3", "Carpenter", "Demolition work", ["2"], "demolition", materials=["lumber"]),
            Task("4", "Plumber", "Rough-in plumbing", ["3"], "rough_in", materials=["pvc pipes", "copper pipes"]),
            Task("5", "Electrician", "Rough-in electrical", ["3"], "rough_in", materials=["electrical wire", "outlets"]),
            Task(
                "6",
                "Architect",
                "Rough-in inspection",
            ...
            Task("7", "Carpenter", "Install drywall", ["6"], "finishing", materials=["plywood", "lumber"]),
            Task("8", "Painter", "Paint and tile work", ["7"], "finishing", materials=["interior paint", "primer"]),
            Task("9", "Plumber", "Install fixtures", ["8"], "finishing", materials=["sink", "pvc pipes"]),
            Task("10", "Electrician", "Install light fixtures", ["8"], "finishing", materials=["light fixtures", "electrical wire"]),
            Task(
                "11",
                "Architect",
                "Final inspection",
    ...
    def _create_new_construction_tasks(self, **kwargs) -> List[Task]:
        ...
        return [
            ...
            Task("3", "Mason", "Pour foundation", ["2"], "foundation", materials=["concrete", "bricks"]),
            Task("4", "Carpenter", "Frame walls and roof", ["3"], "framing", materials=["2x4 lumber", "plywood"]),
            Task("5", "Roofer", "Install roof", ["4"], "framing", materials=["shingles", "underlayment"]),
            Task("6", "Electrician", "Electrical rough-in", ["4"], "rough_in", materials=["electrical wire", "outlets"]),
            Task("7", "Plumber", "Plumbing rough-in", ["4"], "rough_in", materials=["pvc pipes", "copper pipes"]),
            Task("8", "HVAC", "HVAC installation", ["4"], "rough_in", materials=["hvac unit", "ductwork"]),
            Task(
                "9",
                "Architect",
                "Rough-in inspection",
            ...
            Task("10", "Carpenter", "Install drywall", ["9"], "finishing", materials=["plywood", "lumber"]),
            Task("11", "Painter", "Paint interior", ["10"], "finishing", materials=["interior paint", "primer"]),
            Task("12", "Carpenter", "Install flooring and trim", ["11"], "finishing", materials=["plywood", "lumber"]),
            Task("13", "Electrician", "Install fixtures", ["10"], "finishing", materials=["light fixtures", "outlets"]),
            Task("14", "Plumber", "Install fixtures", ["10"], "finishing", materials=["sink", "pvc pipes"]),
            Task(
                "15",
                "Architect",
                "Final inspection",
    ...
    def _create_addition_tasks(self, **kwargs) -> List[Task]:
        ...
        return [
            ...
            Task("2", "Architect", "Apply for permits", ["1"], "permitting"),
            Task("3", "Mason", "Pour foundation", ["2"], "foundation", materials=["concrete", "bricks"]),
            Task("4", "Carpenter", "Frame addition", ["3"], "framing", materials=["2x4 lumber", "plywood"]),
            Task("5", "Roofer", "Extend roof", ["4"], "framing", materials=["shingles", "underlayment"]),
            Task("6", "Electrician", "Electrical rough-in", ["4"], "rough_in", materials=["electrical wire", "outlets"]),
            Task("7", "Plumber", "Plumbing rough-in", ["4"], "rough_in", materials=["pvc pipes", "copper pipes"]),
            Task("8", "HVAC", "Extend HVAC", ["4"], "rough_in", materials=["hvac unit", "ductwork"]),
            Task(
                "9",
                "Architect",
                "Rough-in inspection",
            ...
            Task("10", "Carpenter", "Drywall and finishing", ["9"], "finishing", materials=["plywood", "lumber"]),
            Task("11", "Painter", "Paint", ["10"], "finishing", materials=["interior paint", "primer"]),
            Task(
                "12",
                "Architect",
                "Final inspection",
